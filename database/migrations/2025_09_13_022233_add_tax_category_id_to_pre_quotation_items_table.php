...
return new class extends Migration
{
    ...
    {
        Schema::table('pre_quotation_items', function (Blueprint $table) {
            ...
            $table->index(['tax_category_id', 'pre_quotation_id']); // Composite index for performance
        });
    }
    ...
    public function down(): void
    {
        Schema::table('pre_quotation_items', function (Blueprint $table) {
            ...
            $table->dropIndex(['tax_category_id', 'pre_quotation_id']);
