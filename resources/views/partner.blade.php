            ...
            <div class="flex justify-between items-start">
                <div>
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold text-gray-800 text-[14px]">Partner Management</h1>
                    </div>
                    <p class="text-xs text-gray-500 mt-1 ml-8 text-[11px]">Manage all partner information and case assignments.</p>
                </div>
                
                <!-- Add Partner Button -->
                <a href="{{ route('partner.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded-md text-xs font-medium flex items-center">
