            ...
            <div class="flex justify-between items-start">
                <div>
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold text-gray-800 text-[14px]">Quotation Management</h1>
                    </div>
                    <p class="text-xs text-gray-500 mt-1 ml-8 text-[11px]">Manage all client quotations and pricing proposals.</p>
                </div>
