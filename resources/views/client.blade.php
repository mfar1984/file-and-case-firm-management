    ...
    <div class="bg-white rounded shadow-md border border-gray-300">
        ...
        <div class="hidden md:block p-6">
            ...
            <div class="flex justify-between items-center mb-2">
                ...
                <div class="flex gap-2 items-center">
                    ...
                    <select id="statusFilter" onchange="filterClients()" class="custom-select border border-gray-300 rounded pl-4 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                        <option value="">All Status</option>
                        <option value="Active">Active</option>
                        <option value="Inactive">Inactive</option>
                    </select>

                    <button onclick="filterClients()" class="px-3 py-2 bg-blue-500 text-white rounded text-xs hover:bg-blue-600 transition-colors">
                        🔍 Search
                    </button>
        ...
        <div class="md:hidden p-4">
            ...
            <div class="space-y-3 mb-4">
                ...
                <!-- Search and Filters -->
                <div class="space-y-2">
                    <input type="text" id="searchFilterMobile" placeholder="Search clients..."
                           onkeyup="filterClients()"
                    ...
                    <div class="flex gap-2">
                        <select id="statusFilterMobile" onchange="filterClients()" class="custom-select flex-1 border border-gray-300 rounded pl-4 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
                            <option value="">All Status</option>
                            <option value="Active">Active</option>
                            <option value="Inactive">Inactive</option>
                        </select>
            ...
            <div class="space-y-4" id="clients-mobile-container">
            <!-- Client Card 1 -->
...
document.addEventListener('DOMContentLoaded', function() {
    // Get all client data from the page
    const clientRows = document.querySelectorAll('tbody tr');
    allClients = Array.from(clientRows).map((row, index) => ({
        id: index,
        element: row,
...
function displayClients() {
    ...
    allClients.forEach(client => {
        if (client.element) client.element.style.display = 'none';
    });

    // Show filtered clients for current page
    const clientsToShow = filteredClients.slice(startIndex, endIndex);
    clientsToShow.forEach(client => {
        if (client.element) client.element.style.display = '';
    });
}
...
function filterClients() {
    ...
    filteredClients = allClients.filter(client => {
        const matchesSearch = searchTerm === '' || client.searchText.includes(searchTerm);
        const matchesStatus = statusFilter === '' || client.searchText.includes(statusFilter.toLowerCase());
