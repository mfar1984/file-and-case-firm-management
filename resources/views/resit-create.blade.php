...
<div class="px-4 md:px-6 pt-4 md:pt-6 pb-6 max-w-7xl mx-auto">
        ...
        <form class="p-4 md:p-6">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Select Invoice *</label>
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-md text-xs focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            <option value="">Choose from existing invoices</option>
                            <option value="INV-2025-001">INV-2025-001 - ATLINE SDN BHD (RM 5,000.00)</option>
                            <option value="INV-2025-002">INV-2025-002 - TECH SOLUTIONS (RM 8,500.00)</option>
                            <option value="INV-2025-003">INV-2025-003 - GLOBAL TRADING (RM 3,200.00)</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Invoice Amount</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50" value="RM 5,000.00" readonly>
                    </div>
                    
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Outstanding Amount</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md text-xs focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50" value="RM 5,000.00" readonly>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Receipt No. *</label>
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-2">Received By *</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md text-xs focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter receiver name" required>
                    </div>
    ...
    payments: [
        { description: 'Full payment for invoice INV-2025-001', amount: 5000 }
    ],
    totalAmount() {
        return this.payments.reduce((sum, payment) => sum + payment.amount, 0);
    },
    addPayment() {
        this.payments.push({ description: '', amount: 0 });
    },
    insertPayment() {
        this.payments.unshift({ description: '', amount: 0 });
    },
    removePayment(idx) {
                ...
                <div class="hidden md:block overflow-x-auto border border-gray-200 rounded-lg">
                    <table class="min-w-full">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Payment Description</th>
                            ...
                            <template x-for="(payment, idx) in payments" :key="idx">
                                <tr>
                                    <td class="px-4 py-3 align-middle">
                                        <textarea x-model="payment.description" class="w-full px-3 py-1 border border-gray-300 rounded text-xs focus:outline-none focus:ring-1 focus:ring-blue-500 resize-y align-middle" placeholder="Payment description" rows="1"></textarea>
                                    </td>
                                    <td class="px-4 py-3 text-center">
                                        <input type="number" min="0" step="0.01" x-model.number="payment.amount" class="w-32 px-3 py-1 border border-gray-300 rounded text-xs focus:outline-none focus:ring-1 focus:ring-blue-500 text-center" placeholder="0.00">
                                    </td>
                                    <td class="px-4 py-3 text-center">
                                        <div class="flex justify-center">
                                            <button type="button" @click="removePayment(idx)" class="text-red-600 hover:text-red-800 text-base font-light" title="Delete Payment">❌</button>
                                        </div>
                                    </td>
                                </tr>
                            </template>
