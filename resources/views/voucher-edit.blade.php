                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="payee_name" value="{{ old('payee_name', $voucher->payee_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_person" value="{{ old('contact_person', $voucher->contact_person) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="phone" value="{{ old('phone', $voucher->phone) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('phone')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $voucher->email) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-sm text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('email')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <textarea name="payee_address" rows="3"
